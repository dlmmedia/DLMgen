...
export const GenerationLoader = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full text-white animate-in fade-in duration-500">
            <div className="relative mb-8">
                <div className="absolute inset-0 bg-primary/20 rounded-full blur-xl animate-pulse" />
                <div className="w-24 h-24 bg-black/40 border border-primary/30 rounded-full flex items-center justify-center relative z-10 backdrop-blur-md">
            ...
            <p className="text-gray-400 text-sm">Crafting your unique sound signature...</p>
