        ...
        <div className="flex items-center gap-1.5">
          ...
          {infoTooltip && (
            <div className="group relative">
              <div className="w-4 h-4 rounded-full bg-gray-200 dark:bg-white/10 flex items-center justify-center text-[10px] text-gray-500 dark:text-gray-400 cursor-help">
                i
              </div>
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-900 dark:bg-black/90 border border-gray-700 dark:border-white/10 rounded text-xs text-gray-100 dark:text-gray-300 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50">
                {infoTooltip}
              </div>
            </div>
          )}
          ...
          return (
            <button
              ...
              className={`flex-1 h-6 rounded transition-all duration-150 ${
                isActive
                  ? 'bg-primary shadow-[0_0_8px_rgba(153,27,27,0.5)]'
                  : isBeforeActive
