...
export const CreatorCard: React.FC<CreatorCardProps> = ({ creator }) => {
    ...
    return (
        <div className="flex items-center justify-between p-3.5 hover:bg-white/[0.04] rounded-xl transition-all group">
            {/* Avatar & Info */}
            <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-full overflow-hidden bg-white/5 border border-white/5 shadow-lg group-hover:border-primary/20 transition-colors">
                    <img
                ...
                <div>
                    <div className="flex items-center gap-1.5">
                        <span className="font-bold text-white/90 text-[13px]">{creator.name}</span>
                        {creator.isVerified && (
